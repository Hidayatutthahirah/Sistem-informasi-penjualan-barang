									...
									<div class="panel-footer">
										<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
											...
											<span class="pull-right">
												<button type="submit"  class="btn btn-warning btn-sm" value="Tambah"><i class="fa fa-pencil"> Ganti Foto</i></button>
											</span>
										</form>
										<br/>
										<br/>
											...
											<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="form-actions pull-right">
														<input type="hidden" name="id" value="<?php echo $hasil['id_member']; ?>">
														<button class="btn btn-warning" name="btn" value="Tambah" style="border-radius:0px;"><i class="fa fa-pencil"></i> Ubah Profil</button>
													</div>
												</fieldset>
											</form>
										</div>
											 ...
											 <form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
												...
												<fieldset>
													...
													<div class="pull-right">															
														...
														<button type="submit" class="btn btn-warning" value="Tambah" style="border-radius:0px;" name="proses"><i class="fa fa-pencil"></i> Ubah Password</button>
													</div>
												</fieldset>
											</form>
										</div>
